...
import { LayoutDashboard, ShoppingBag, Download, MapPin, User, LogOut, Gift, MessageSquare } from 'lucide-react';
...
const ProfileNavigation = () => {
    ...
    const menuItems = [
        ...
        { label: 'Komentáře', href: '/my-account/reviews', icon: MessageSquare },
